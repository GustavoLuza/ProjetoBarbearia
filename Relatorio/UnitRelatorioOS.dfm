object FormRelatorioOS: TFormRelatorioOS
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Relat'#243'rio gerencial de ordens de servi'#231'o'
  ClientHeight = 213
  ClientWidth = 528
  Color = clBtnFace
  ...
  object GroupBoxOS: TGroupBox
    ...
    object DataInicial: TDateTimePicker
      ...
      Width = 186
      Height = 21
      Date = 43063.800797106480000000
      Time = 43063.800797106480000000
      TabOrder = 2
    end
    object DataFinal: TDateTimePicker
      ...
      Width = 186
      Height = 21
      Date = 43063.800866851850000000
      Time = 43063.800866851850000000
      TabOrder = 3
    end
  end
  object Query: TIBQuery
    ...
    SQL.Strings = (
      ...
      ''
      ''
      'WHERE OS.DATA_OS BETWEEN :INICIAL AND :FINAL'
      ''
  ...
  object DatasetOS: TfrxDBDataset
  ...
  object ReportOS: TfrxReport
    ...
    ReportOptions.CreateDate = 43063.799779201390000000
    ReportOptions.LastChange = 43063.799779201390000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        DataSetName = 'frxDBDataset1'
        RowCount = 0
        object frxDBDataset1CODIGO_OS: TfrxMemoView
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8W = (
            'Quantidade de ordens de servi'#231'o emitidas: [COUNT(MasterData1)]')
          ParentFont = False
        end
